...
declare -a vmass=("125") #"50" "75" "100" "125" "150" "200" "250" "300" "400" "500")
...
if [[ ($sample = "All") || ($sample != "All" && $sample = "QCD") ]]; then 
    ...
    hadd  "$dir"/QCD_HT100to200.root ../zprimebits/QCD_HT100to200_13TeV_mc/*.root;
    hadd  "$dir"/QCD_HT200to300.root ../zprimebits/QCD_HT200to300_13TeV_mc/*.root;
    hadd  "$dir"/QCD_HT300to500.root ../zprimebits/QCD_HT300to500_13TeV_mc/*.root;
    hadd  "$dir"/QCD_HT500to700.root ../zprimebits/QCD_HT500to700_13TeV_mc/*.root;
    hadd  "$dir"/QCD_HT700to1000.root ../zprimebits/QCD_HT700to1000_13TeV_mc/*.root;
    hadd  "$dir"/QCD_HT1000to1500.root ../zprimebits/QCD_HT1000to1500_13TeV_mc/*.root;
    hadd  "$dir"/QCD_HT1500to2000.root ../zprimebits/QCD_HT1500to2000_13TeV_mc/*.root;
    hadd  "$dir"/QCD_HT2000toInf.root ../zprimebits/QCD_HT2000toInf_13TeV_mc/*.root;
fi
